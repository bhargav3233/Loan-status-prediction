# -*- coding: utf-8 -*-
"""
Created on Sat Aug  6 16:59:14 2022
...
pickle_in = open('D:/Loan/classifier.pkl', 'rb') 
...
def prediction(Gender, Married,Dependents,Education,Self_Employed,ApplicantIncome,CoapplicantIncome,LoanAmount,Loan_Amount_Term,Credit_History,Property_Area):   
    ...
    # Making predictions 
    prediction = classifier.predict([[Gender, Married,Dependents,Education,Self_Employed,ApplicantIncome,CoapplicantIncome,LoanAmount,Loan_Amount_Term,Credit_History,Property_Area]])
...
def main():       
    ...
    Self_Employed = st.selectbox('Self_Employed',("Employed","Un employed"))
...
#('Your loan is {}'.format(result))print(LoanAmount)